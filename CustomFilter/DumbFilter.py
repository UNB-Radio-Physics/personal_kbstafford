...
def generate_signals(num_iterations, input_freq, noise_level, sampling_freq):
    ...
    desired_signal = np.sin(2 * np.pi * input_freq * t / num_iterations)  # Corrected line
...
def run_filter(sampling_freq, numtaps, bands, desired, weights, mu, num_iterations, input_freq, noise_level):
    ...
    output_signal, error_signal, final_coeffs = adaptive_filter_lms(initial_filter, input_signal, desired_signal, mu,
                                                                    num_iterations)
...
def main():
    if choose_implementation():
        ...
        run_filter(args.sampling_freq, args.numtaps, args.bands, args.desired, args.weights, args.mu, args.num_iterations, args.input_freq,
                   args.noise_level)
